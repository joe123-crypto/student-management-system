...
const Layout: React.FC<LayoutProps> = ({ children, title, role, userName, onLogout, activeTab, setActiveTab, profilePicture }) => {
  return (
    <div className="flex  bg-slate-50 font-['Inter']">
      <aside
        style={{ left: 'max(0px, calc((100vw - 1200px) / 2))' }}
        className="w-72 bg-white border-r border-slate-100 flex flex-col fixed top-0 h-screen hidden md:flex z-20"
      >
        <div className="p-8">
        ...
        <main className="flex-1">
          <div className="max-w-6xl mx-auto px-6 lg:px-12 py-12">
            <div className="mb-10 flex justify-between items-start">
              ...
              <Button onClick={onLogout} variant="ghost" className="hidden md:flex p-3 bg-white border border-slate-100 text-red-500 rounded-2xl shadow-sm hover:bg-red-50 transition-all">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
              </Button>
